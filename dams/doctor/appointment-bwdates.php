...
<head>
  ...
  <title>SecureMed - Dates de report des rendez-vous</title>
      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Dates de report de rendez-vous</h3>
          ...
          <div class="widget-body">
            ...
            <form class="form-horizontal" method="post" name="bwdatesreport" action="appointment-bwdates-reports-details.php">
              <div class="form-group">
                <label for="exampleTextInput1" class="col-sm-3 control-label">De la date du:</label>
                <div class="col-sm-9">
                  <input type="date" class="form-control" id="fromdate" name="fromdate" value="" required='true'>
                </div>
              </div>
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">A la date du:</label>
                <div class="col-sm-9">
