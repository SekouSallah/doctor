...
<head>
  ...
  <title>SecureMed - Changement de mot de passe</title>
...
{
alert('Nouveau mot de passe et Champs de mot de passe confirmé incorrect');
      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Changer mot de passe</h3>
          ...
          <div class="widget-body">
            ...
            <form class="form-horizontal" onsubmit="return checkpass();" name="changepassword" method="post">
              <div class="form-group">
                <label for="exampleTextInput1" class="col-sm-3 control-label">Ancien mot de passe:</label>
                <div class="col-sm-9">
                  <input type="password" class="form-control" name="currentpassword" id="currentpassword"required='true'>
                </div>
              </div>
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Nouveau mot de passe:</label>
                <div class="col-sm-9">
                  <input type="password" class="form-control" name="newpassword"  class="form-control" required="true">
                </div>
              </div>
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Confirmez le nouveau mot de passe:</label>
                <div class="col-sm-9">
              ...
              <div class="row">
                <div class="col-sm-9 col-sm-offset-3">
                  <button type="submit" class="btn btn-success" name="submit">Changer</button>
                </div>
              </div>
            </form>
          </div><!-- .widget-body -->
