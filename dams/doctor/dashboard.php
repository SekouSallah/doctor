...
<head>
	...
	<title>SecureMed - Tableau de Bord</title>
...
?>
						<div class="pull-left">
							...
							<small class="text-color">Total des nouveaux rendez-vous</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-paperclip"></i></span>
					</div>
					<footer class="widget-footer bg-warning">
						<a href="new-appointment.php"><small> Voir détail</small></a>
			...
			<div class="col-md-6 col-sm-6">
				<div class="widget stats-widget">
					<div class="widget-body clearfix">
						<?php 
						 $docid=$_SESSION['damsid'];;
$sql ="SELECT * from  tblappointment where Status='Accepté' && Doctor=:docid ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':docid', $docid, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
						<div class="pull-left">
							...
							<small class="text-color">Total accepté</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-ban"></i></span>
					</div>
					<footer class="widget-footer bg-success">
						<a href="approved-appointment.php"><small> Voir détail</small></a>
				...
				<div class="widget stats-widget">
					<div class="widget-body clearfix">
						<div class="pull-left">
							<?php 
						 $docid=$_SESSION['damsid'];;
$sql ="SELECT * from  tblappointment where Status='Annulé' && Doctor=:docid ";
$query = $dbh -> prepare($sql);
$query-> bindParam(':docid', $docid, PDO::PARAM_STR);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
...
?>
							...
							<small class="text-color">Rendez-vous annulés</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-unlock-alt"></i></span>
					</div>
					<footer class="widget-footer bg-danger">
						<a href="cancelled-appointment.php"><small> Voir détail</small></a>
...
?>
							...
							<small class="text-color">Total des rendez-vous</small>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-file-text-o"></i></span>
					</div>
					<footer class="widget-footer bg-primary">
						<a href="all-appointment.php"><small> Voir détail</small></a>
