  ...
  <div id="app-customizer" class="app-customizer">
    ...
    <div class="customizer-tabs">
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#menubar-customizer" aria-controls="menubar-customizer" role="tab" data-toggle="tab">Barre de menu</a></li>
        <li role="presentation"><a href="#navbar-customizer" aria-controls="navbar-customizer" role="tab" data-toggle="tab">Barre de navigation</a></li>
      </ul><!-- .nav-tabs -->
      ...
      <div class="tab-content">
        <div role="tabpanel" class="tab-pane in active fade" id="menubar-customizer">
          <div class="hidden-menubar-top hidden-float">
            <div class="m-b-0">
              <label for="menubar-fold-switch">Plier barre de menu</label>
          ...
          <div class="radio radio-default m-b-md">
            ...
            <label for="menubar-light-theme">Clair</label>
          </div>
          ...
          <div class="radio radio-inverse m-b-md">
            ...
            <label for="menubar-dark-theme">Sombre</label>
          </div>
        </div><!-- .tab-pane -->
