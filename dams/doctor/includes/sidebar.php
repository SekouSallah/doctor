    ...
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
       ...
       <li class="has-submenu">
          ...
          <ul class="submenu">
            <li><a href="new-appointment.php"><span class="menu-text">Nouveaux rendez-vous</span></a></li>
            <li><a href="approved-appointment.php"><span class="menu-text">Rendez-vous acceptés</span></a></li>
            <li><a href="cancelled-appointment.php"><span class="menu-text">Rendez-vous annulés</span></a></li>
            <li><a href="all-appointment.php"><span class="menu-text">Tous les rendez-vous</span></a></li>
