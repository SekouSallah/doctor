...
echo "<script>alert('Détail invalide');</script>";
}
}
...
<head>
	...
	<title>SecureMed - Authentification</title>
...
<body class="simple-page">
	...
	<form method="post" name="login">
		<div class="form-group">
			<input type="text" class="form-control" placeholder="Enter Email ID" required="true" name="email">
		</div>
