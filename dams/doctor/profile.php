...
$query->execute();
        ...
        echo '<script>alert("Mise à jour du profil effectuée!")</script>';
...
<head>
  ...
  <title>SecureMed - Profil docteur</title>
      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Profil docteur</h3>
...
{               ?>
            <form class="form-horizontal" method="post">
              <div class="form-group">
                <label for="exampleTextInput1" class="col-sm-3 control-label">ID Docteur:</label>
                <div class="col-sm-9">
                  <input id="fname" type="text" class="form-control" placeholder="Nom complet" name="fname" required="true" value="<?php  echo $row->FullName;?>">
                </div>
              </div>
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Numéro de téléphone:</label>
                <div class="col-sm-9">
              ...
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Spécialisation:</label>
                <div class="col-sm-9">
...
{               ?>
        <option value="<?php  echo htmlentities($row1->ID);?>"><?php  echo htmlentities($row1->Specialization);?></option><?php $cnt=$cnt+1;}} ?> 
              ...
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Date d'enregistrement:</label>
                <div class="col-sm-9">
