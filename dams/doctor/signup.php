...
echo "<script>alert('Erreur ! Merci de réessayer plus tard');</script>";
}
}
 else
{
...
<head>
	...
	<title>SecureMed - Inscription</title>
...
<body class="simple-page">
	...
	<h4 class="form-title m-b-xl text-center">S'inscrire avec un compte SecureMed</h4>
	<form action="" method="post">
		<div class="form-group">
			<input id="fname" type="text" class="form-control" placeholder="Nom complet" name="fname" required="true">
		</div>
		...
		<div class="form-group">
			<input id="mobno" type="text" class="form-control" placeholder="Téléphone" name="mobno" maxlength="10" pattern="[0-9]+" required="true">
		</div>
		<div class="form-group">
...
{               ?>
		...
		<div class="form-group">
			<input id="password" type="password" class="form-control" placeholder="Mot de passe" name="password" required="true">
		</div>

		<input type="submit" class="btn btn-primary" value="Enrégistrer" name="submit">
	</form>
</div><!-- #login-form -->
